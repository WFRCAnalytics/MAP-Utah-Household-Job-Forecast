...
sPlanArea = "AEMP PROJECTIONS by PLANAREA"; // layer for outline over TAZ display
sPlanAreaOutline = "AEMP PROJECTIONS by PLANAREA-Copy"; // layer for outline over TAZ display
sMasks = "Masks Dissolve";
sREMMBoundary = "REMMBoundary";
sCenters = "Wasatch Choice 2050 Centers (Vision Map) - WC2050Centers";
sCentersOutline =
  "Wasatch Choice 2050 Centers (Vision Map) - WC2050Centers Outline";
...
dGeo = [
  {
    ...
    idfieldname: "CO_TAZID",
    idfieldtype: "number",
    chartfileprefix: "TAZ",
    charttitletext: "COTAZID ",
    legendtitletext: "TAZ",
    roundchartvalues: 1,
    minScaleForLabels: 87804,
    compareGeos: [
      { value: "CITYAREA", label: "City Area" },
      { value: "DISTMED", label: "Medium District" },
  ...
  },
  {
    ...
    idfieldname: "CITY_NAME",
    idfieldtype: "string",
    chartfileprefix: "CITY_NAME",
    charttitletext: "",
    legendtitletext: "City",
    roundchartvalues: 1,
    minScaleForLabels: 1000000,
    compareGeos: [
      { value: "COUNTY", label: "County" },
      { value: "REGION", label: "Region" },
    ],
  ...
  {
    label: "Medium Districts",
    value: "DISTMED",
    defaultLineWidth: 1.5,
    idfieldname: "DMED_NAME",
    idfieldtype: "string",
    chartfileprefix: "DMED_NAME",
    charttitletext: "",
    legendtitletext: "District",
    roundchartvalues: 1,
    minScaleForLabels: 1000000,
    compareGeos: [
      { value: "COUNTY", label: "County" },
  ...
  },
  {
    ...
    value: "DISTLRG",
    defaultLineWidth: 1.5,
    idfieldname: "DLRG_NAME",
    idfieldtype: "string",
    chartfileprefix: "DLRG_NAME",
    charttitletext: "",
    legendtitletext: "District",
    roundchartvalues: 1,
    minScaleForLabels: 1000000,
  ...
  },
  {
    ...
    idfieldname: "CO_NAME",
    idfieldtype: "string",
    chartfileprefix: "CO_NAME",
    charttitletext: "",
    legendtitletext: "County",
    roundchartvalues: 1,
    minScaleForLabels: 2000000,
    compareGeos: [{ value: "REGION", label: "Region" }],
  },
  {
    label: "Unified Plan Areas",
    value: "PLANAREA",
    defaultLineWidth: 2.5,
    idfieldname: "PLAN_AREA",
    idfieldtype: "string",
    chartfileprefix: "PLAN_AREA",
    charttitletext: "",
    legendtitletext: "Unified Plan Area",
    roundchartvalues: 1,
    minScaleForLabels: 2000000,
    compareGeos: [{ value: "REGION", label: "Region" }],
  },
...
var dCat = [
  {
    label: "Households",
    value: "HH",
    chartcolor: "darkgoldenrod",
    tabletitle: "House-holds",
    legendtitle: "Number of Households",
  },
  {
    label: "Population",
    value: "POP",
    chartcolor: "goldenrod",
    tabletitle: "Popu-lation",
    legendtitle: "Number of People",
  },
  {
    label: "Industrial Jobs",
    value: "IND",
    chartcolor: "magenta",
    tabletitle: "Industrial Jobs",
    legendtitle: "Number of Industrial Jobs",
  },
  {
    label: "Office Jobs",
    value: "OTHR",
    chartcolor: "royalblue",
    tabletitle: "Office Jobs",
    legendtitle: "Number of Office Jobs",
  },
  {
    label: "Retail Jobs",
    value: "RTL",
    chartcolor: "maroon",
    tabletitle: "Retail Jobs",
    legendtitle: "Number of Retail Jobs",
  },
  {
    label: "Total Jobs",
    value: "TPCL",
    chartcolor: "darkslateblue",
    tabletitle: "Total Jobs",
    legendtitle: "Number of Total Jobs",
  },
  {
    label: "HH+Job Intensity",
    value: "HJI",
    chartcolor: "darkgreen",
    tabletitle: "HH+Job Intensity",
    legendtitle: "Household+Job Intensity",
  },
];
...
define([
  ...
  return declare([BaseWidget], {
    ...
    startup: function () {
      ...
      // Populate areas for chart calcs - HOPEFULLY SHORT-TERM FIX
      dojo.xhrGet({
        url: "widgets/SESidebar/data/chart/PLANAREA_DevAcres.json",
        handleAs: "json",
        load: function (obj) {
          /* here, obj will already be a JS object deserialized from the JSON response */
          console.log("PLANAREA_DevAcres.json");
          acres_planarea = obj;
        },
        error: function (err) {
          /* this will execute if the response couldn't be converted to a JS object,
      ...
      var _cmbGeos = new Select(
        {
          ...
          onChange: function () {
            ...
            _cmbGeoCompare.set(
              "options",
              dGeo.find((o) => o.value === curGeo).compareGeos
            );
            curGeoCompare = dGeo.find((o) => o.value === curGeo).compareGeos[0]
              .value;
      ...
      function selectFeatures(evt) {
        ...
        var _clickableLayerIDFieldName = dGeo.find(
          (o) => o.value === curGeo
        ).idfieldname;
        var _clickableLayerIDFieldType = dGeo.find(
          (o) => o.value === curGeo
        ).idfieldtype;

        var _query = new Query();
        _query.geometry = pointToExtent(
          map,
          evt.mapPoint,
          iPixelSelectionTolerance
        );
        ...
        function showResults(results) {
          ...
          if (resultCount >= 1) {
            ...
            switch (_clickableLayerIDFieldType) {
              case "string":
                _querylayer.where =
                  _clickableLayerIDFieldName + "='" + curID + "'";
                break;
              case "number":
      ...
      for (c in dCat) {
        cChart.addSeries(
          ...
          {
            stroke: { color: new Color(dCat[c].chartcolor), width: 3 },
            fill: new Color(dCat[c].chartcolor),
          }
        );
        cChartBasic.addSeries(
          dCat[c].label,
          [
            { x: 0, y: 0 },
            { x: 1, y: 0 },
      ...
      lLegend = new dojox.charting.widget.SelectableLegend(
        { chart: cChart, outline: true, horizontal: false },
        "LEGENDSE"
      );
      lLegendBasic = new dojox.charting.widget.SelectableLegend(
        { chart: cChartBasic, outline: true, horizontal: false },
        "LEGENDSEBASIC"
      );
      ...
      var horizSlider = new HorizontalSlider(
        {
          ...
          onChange: function () {
            ...
            dom.byId("OPACITY").innerHTML =
              ((1 - curOpacity) * 100).toFixed(0) + "%";
          },
        },
        "HORIZSLIDER"
      );
    ...
    _updateDisplay_Step1_CompareGeos: function () {
      if (dom.byId("chkCompareGeo").checked == true) {
        // if checked get data from compare geos
        ...
        if (curGeoCompare == "REGION") {
          ...
          var _compareLayerIDFieldName = dGeo.find(
            (o) => o.value === "COUNTY"
          ).idfieldname;
          var _compareLayerIDFieldType = dGeo.find(
            (o) => o.value === "COUNTY"
          ).idfieldtype;
        } else {
          _sLayerNameCompare = curCat + " PROJECTIONS by " + curGeoCompare;
          var _compareLayerIDFieldName = dGeo.find(
            (o) => o.value === curGeoCompare
          ).idfieldname;
          var _compareLayerIDFieldType = dGeo.find(
            (o) => o.value === curGeoCompare
          ).idfieldtype;
        ...
        for (var j = 0, jl = layerInfosObject._layerInfos.length; j < jl; j++) {
          ...
          if (currentLayerInfo.title == _sLayerNameCompare) {
            //must mach layer title
          ...
          for (var i = 0; i < featureSet.features.length; i++) {
            ...
            if (curTab == "FORECAST") {
              ...
              if (_absoluteorpercent == "absolute") {
                ...
                var _score =
                  (_fA["N_" + curYearTo] - _fA["N_" + curYearFrom]) /
                  _fA["N_" + curYearFrom];
              }
            } else if (curTab == "NEWVSOLD") {
              if (_absoluteorpercent == "absolute") {
                var _score =
                  _fA["N_" + curYearNewOld] - _fA["O_" + curYearNewOld];
              } else if (_absoluteorpercent == "percent") {
                var _score =
                  (_fA["N_" + curYearNewOld] - _fA["O_" + curYearNewOld]) /
                  _fA["O_" + curYearNewOld];
              }
            }
        ...
        // if not checked, go straight to next step... REPLACE WITH ASYNCHRONOUS FUNCTIONS
    ...
    _updateDisplay_Step2_MainLayer: function () {
      ...
      for (var j = 0, jl = layerInfosObject._layerInfos.length; j < jl; j++) {
        var currentLayerInfo = layerInfosObject._layerInfos[j];
        if (currentLayerInfo.title == _sLayerName) {
          //must mach layer title
          lyrDisplay = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sCityAreas) {
            var _lyrCityAreas = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sCityAreasOutline) {
          var _lyrCityAreasOutline =
            layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sDistMed) {
            var _lyrDistMed = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sDistMedOutline) {
            var _lyrDistMedOutline = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sDistLrg) {
            var _lyrDistLrg = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sDistLrgOutline) {
            var _lyrDistLrgOutline = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sCounty) {
            var _lyrCounty = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sCountyOutline) {
            var _lyrCountyOutline = layerInfosObject._layerInfos[j].layerObject;
        } else if (currentLayerInfo.title == sPlanArea) {
            var _lyrPlanArea = layerInfosObject._layerInfos[j].layerObject;
        ...
        } else if (currentLayerInfo.title == sPlanAreaOutline) {
            var _lyrPlanAreaOutline = layerInfosObject._layerInfos[j].layerObject;
      ...
      if (typeof classbreaks !== "undefined") {
        ...
        var defaultLineSE = new SimpleLineSymbol(
          SimpleLineSymbol.STYLE_SOLID,
          Color.fromHex(sCLightGrey),
          _dLineWidth
        );
        ...
        if (curTab == "FORECAST") {
          ...
          var _scoreExpDen =
            '$feature["N_' + curYear + '"] / $feature.DEVACRES';
          var _absoluteorpercent = "absolute"; // only absolute
          if (curMet == "count") {
            var _sLegendTitle =
              dCat.find((o) => o.value === curCat).legendtitle +
              " per " +
              dGeo.find((o) => o.value === curGeo).legendtitletext +
              " in " +
              curYear;
        ...
        if (_absoluteorpercent == "percent") {
          ...
          _scoreExpDen =
            "(" + _scoreExpDen + ") / " + _scoreExpDen.split("-")[1]; // add last item as denominator
        }
            ...
            var _arcadeExp =
              ...
              "\
                  if (getCompareValue('REGION')==-999999) { \
                    ...
                    var displayvalue = (" +
              _scoreExp +
              ") / getCompareValue('REGION');\
                  }";
          } else {
            var _arcadeExp =
              strArcadeCompareFunction +
              "\
                  if (getCompareValue($feature['" +
              dGeo.find((o) => o.value === curGeoCompare).idfieldname +
              "'])==-999999) { \
                    var displayvalue = -999999;\
                  } else {\
                    var displayvalue = (" +
              _scoreExp +
              ") / getCompareValue($feature['" +
              dGeo.find((o) => o.value === curGeoCompare).idfieldname +
              "']);\
                  }";
          }
        ...
        var _classbreaks = classbreaks.filter(function (classbreaks) {
          return (
            classbreaks.geography == curGeo &&
        ...
        if (typeof _classbreaks == "undefined") {
          ...
          for (var l = _classbreaks.numClasses - 1; l >= 0; l--) {
            ...
            if (l < _classbreaks.numClasses - 1) {
              // Max of class is min of nex class
            ...
            if (l == _classbreaks.numClasses - 1) {
              ...
              var _codeblock =
                ...
                _class +
                "'; }";
            } else if (l > 0 && l < _classbreaks.numClasses - 1) {
              // middle classes
              _codeblock +=
            ...
            } else if (l == _classbreaks.numClasses - 1) {
              // last class
              _sLabel =
                "More than " + sBreakMin + " " + _classbreaks.units + _increase;
            ...
            _sLegend =
              '<td width="' +
              100 / _classbreaks.numClasses +
              '%" style="background-color:' +
              _sColor +
              '">&nbsp;</td>' +
              _sLegend; // add text to begining of string
          }
          ...
          var _sLegendTable =
            '<table width="100%"> \
                                    <tr> \
                                        <td colspan="' +
            _classbreaks.numClasses +
            '" align="center"> \
                                            <div id="LEGENDNAME" class="thick thicker">' +
            _sLegendTitle +
            "</div> \
                                        </td> \
                                    </tr> \
            ...
            '</strong></small> \
                                        ...
                                        <td colspan="' +
            String(_classbreaks.numClasses - 4) +
            '" align="center"> \
            ...
            switch (curTab) {
              case "FORECAST":
                if (curMet == "count") {
                  _exp =
                    _arcadeExp +
                    " if (displayvalue==-999999) { return ''; } else if (displayvalue==0) { return '--'; } else if (displayvalue<0.005) { return '<0.1%'; } else if (displayvalue>=0.005) { return Text(displayvalue,'#.0%'); } else { return ''; }";
                } else if ((curMet = "density")) {
                  _exp =
                    _arcadeExp +
                    " if (displayvalue==-999999) { return ''; } else if (displayvalue==0) { return '--'; } else if (displayvalue<0.05 ) { return '<0.1x'; } else if (displayvalue>=0.05 ) { return Text(displayvalue,'#.0x'); } else { return ''; }";
                }
                break;
              case "CHANGE":
              case "NEWVSOLD":
      ...
      var _line = new SimpleLineSymbol(
        SimpleLineSymbol.STYLE_SOLID,
        Color.fromHex("#555555"),
        1.5
      );
      var _line_outline = new SimpleLineSymbol(
        SimpleLineSymbol.STYLE_SOLID,
        Color.fromHex("#FFFFFF"),
        4.5
      );
      var _rs = new SimpleRenderer(
        new SimpleFillSymbol(
          SimpleFillSymbol.STYLE_NULL,
          _line,
          Color.fromHex("#BE222F")
        )
      );
      var _rs_outline = new SimpleRenderer(
        new SimpleFillSymbol(
          SimpleFillSymbol.STYLE_NULL,
          _line_outline,
          Color.fromHex("#FFFFFF")
      ...
      if (
        (curGeo == "CITYAREA" && _checkedCompareGeos == false) ||
        (curGeo == "TAZ" && _checkedCompareGeos == false) ||
        (_checkedCompareGeos == true && curGeoCompare == "CITYAREA")
      ) {
        ...
        _lyrPlanArea.hide();
        _lyrPlanAreaOutline.hide();
      } else if (
        (curGeo == "DISTMED" && _checkedCompareGeos == false) ||
        (curGeo == "TAZ" &&
          _checkedCompareGeos == true &&
          curGeoCompare == "DISTMED")
      ) {
        ...
        (curGeo == "DISTLRG" && _checkedCompareGeos == false) ||
        (curGeo == "TAZ" &&
          _checkedCompareGeos == true &&
          curGeoCompare == "DISTLRG")
      ) {
        ...
        (curGeo == "COUNTY" && _checkedCompareGeos == false) ||
        (_checkedCompareGeos == true && curGeoCompare == "COUNTY")
      ) {
        ...
        (curGeo == "PLANAREA" && _checkedCompareGeos == false) ||
        (_checkedCompareGeos == true && curGeoCompare == "PLANAREA")
      ) {
        _lyrPlanArea.setRenderer(_rs);
        _lyrPlanAreaOutline.setRenderer(_rs_outline);
        _lyrPlanArea.setLabelingInfo([labelClassOff]);
        _lyrPlanAreaOutline.setLabelingInfo([labelClassOff]);
        _lyrCityAreas.hide();
        _lyrCityAreasOutline.hide();
        // _lyrCenter           .hide();
    ...
    _getChartData: function () {
      ...
      var _chartfileprefix = dGeo.find(
        (o) => o.value === curGeo
      ).chartfileprefix;
    ...
    _updateChart: function () {
      ...
      for (c in dCat) {
        ...
        var ssCat_N = new StoreSeries(
          storeTrends,
          {
            query: { C: dCat[c].value },
            sort: [{ attribute: "Y", descending: false }],
          },
          { x: "Y", y: "N" }
        );
        var ssCat_O = new StoreSeries(
          storeTrends,
          {
            query: { C: dCat[c].value },
            sort: [{ attribute: "Y", descending: false }],
      ...
      dom.byId("DETAILSTITLE").innerHTML =
        "<h2>" +
        dGeo.find((o) => o.value === curGeo).charttitletext +
        curID +
        " Trends</h2>";
    ...
    _buildTable: function () {
      ...
      // header row
      var _strHeaderRowHTML =
        '<tr bgcolor="' + sCLightGrey + '"><td><strong>Year</strong></td>';
      ...
      _years = dYears.filter(function (dYears) {
        return dYears.short == 1;
      });

      // get array of year values only
      _yearsonly = _years.map(function (item) {
        return item.value;
      });
      ...
      for (y in _years) {
        ...
        _strDataRowsHMTL_New +=
          "<tr" +
          _rowcolor +
          '><td width="12.5%"><strong>' +
          _years[y] +
          "</strong></td>";
        _strDataRowsHMTL_Old +=
          "<tr" +
          _rowcolor +
          '><td width="12.5%"><strong>' +
          _years[y] +
        ...
        _yeardata = trenddata.filter(function (trenddata) {
          return trenddata.Y == parseInt(_years[y]);
        });
        for (c in dCat) {
          // only run once for each category
          if (y == 0) {
            _strHeaderRowHTML +=
              '<td align="center" width="12.5%"><strong>' +
              dCat.find((o) => o.value === dCat[c].value).tabletitle +
              "</strong></td>";
          }
          ...
          if (curTblVal == "density") {
            ...
            switch (curGeo) {
              case "TAZ":
                var _acres = acres_taz.find(
                  (o) => o.CO_TAZID === curID
                ).DEVACRES;
                break;
              case "CITYAREA":
                var _acres = acres_cityarea.find(
                  (o) => o.CITY_NAME === curID
                ).DEVACRES;
                break;
              case "DISTMED":
                var _acres = acres_distmed.find(
                  (o) => o.DMED_NAME === curID
                ).DEVACRES;
                break;
              case "DISTLRG":
                var _acres = acres_distlrg.find(
                  (o) => o.DLRG_NAME === curID
                ).DEVACRES;
                break;
              case "COUNTY":
                var _acres = acres_county.find(
                  (o) => o.CO_NAME === curID
                ).DEVACRES;
                break;
              case "PLANAREA":
                var _acres = acres_planarea.find(
                  (o) => o.PLAN_AREA === curID
                ).DEVACRES;
                break;
            }
          ...
          if (
            dCat[c].value == curCat &&
            ((_years[y] == curYear && curTab == "FORECAST") ||
              (curTab == "NEWVSOLD" && _years[y] == curYearNewOld) ||
              ((_years[y] == curYearFrom || _years[y] == curYearTo) &&
                curTab == "CHANGE"))
          ) {
          ...
          _strDataRowsHMTL_New +=
            ...
            ">" +
            _sPrefix +
            wSE._NumberWithCommas(_value_New) +
            _sSuffix +
            "</td>";
          if (curTab == "NEWVSOLD") {
            // only  highlight Forecast 2019 Values  if NEWVSOLD
            _strDataRowsHMTL_Old +=
              '<td align="right" width="12.5%"' +
              _sHighlighText +
              ">" +
              _sPrefix +
              wSE._NumberWithCommas(_value_Old) +
              _sSuffix +
              "</td>";
          } else {
            //
      ...
      // final table HTML
      var _strTableHTML_New =
        "<table cellspacing=0 cellpadding=0>" +
        _strHeaderRowHTML +
        _strDataRowsHMTL_New +
        "</table>";
      var _strTableHTML_Old =
        "<table cellspacing=0 cellpadding=0>" +
        _strHeaderRowHTML +
        _strDataRowsHMTL_Old +
        "</table>";
    ...
    _selectFORECAST: function () {
      ...
      dom.byId("FORECAST_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_forecast_blue.png')";
      dom.byId("CHANGE_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_change_white.png' )";
      dom.byId("NEWVSOLD_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_vs_white.png'     )";
    ...
    _selectCHANGE: function () {
      ...
      dom.byId("FORECAST_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_forecast_white.png')";
      dom.byId("CHANGE_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_change_blue.png'   )";
      dom.byId("NEWVSOLD_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_vs_white.png'      )";
    ...
    _selectNEWVSOLD: function () {
      ...
      dom.byId("CHANGE_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_change_white.png'  )";
      dom.byId("NEWVSOLD_ICON").style.backgroundImage =
        "url('widgets/SESidebar/images/icon_vs_blue.png'       )";
    ...
    _openLegend: function () {
      ...
      for (var p = 0; p < pm.panels.length; p++) {
        if (pm.panels[p].label == "Legend") {
          if (pm.panels[p].state != "closed") {
            bOpen = true;
            pm.closePanel(pm.panels[p]);
            dom.byId("SHOWHIDELEGEND").innerHTML =
              "<small>Show Large Legend<small>";
          }
        }
      }
      ...
      if (!bOpen) {
        pm.showPanel(
          this.appConfig.widgetOnScreen.widgets[WIDGETPOOLID_LEGEND]
        );
        dom.byId("SHOWHIDELEGEND").innerHTML =
          "<small>Hide Large Legend<small>";
      }
    },
    ...
    _incrementDown: function () {
      ...
      if (curTab == "FORECAST") {
        var _newYear =
          parseInt(curYear) - parseInt(dom.byId("cmbInterval").value);
        if (parseInt(dom.byId("cmbInterval").value) != 1) {
        ...
        var _newYearFrom =
          parseInt(curYearFrom) - parseInt(dom.byId("cmbInterval").value);
        if (parseInt(dom.byId("cmbInterval").value) != 1) {
        ...
        var _newYearTo =
          parseInt(curYearTo) - parseInt(dom.byId("cmbInterval").value);
        if (parseInt(dom.byId("cmbInterval").value) != 1) {
          if (_newYearTo < 2020) {
            _newYearTo = 2020;
          }
        ...
        var _newYearNewOld =
          parseInt(curYearNewOld) - parseInt(dom.byId("cmbInterval").value);
        if (parseInt(dom.byId("cmbInterval").value) != 1) {
    ...
    _turnOnBasic: function () {
      ...
      if (curTab == "NEWVSOLD") {
        // when basic is selected need to change tab if current one is New Vs Old, which isn't in the basic version
        curTab == "FORECAST";
      }
